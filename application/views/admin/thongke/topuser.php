...
<div class="container-fluid mt-4">
    ...
    <div class="card shadow mb-4">
        <div class="card-header">
            <div class="row">
                <h6 class="col-md-6 d-flex align-items-center font-weight-bold text-primary">Top 10 khách hàng chi tiêu nhiều nhất </h6>
                <!-- Table Search -->
                <div class="col-md-6 d-flex justify-content-end form-inline find-input">
                    ...
                    <select class="form-control ml-2">
                        ...
                        <option value="5">Quận/ huyện</option>
                        <option value="6">Địa chỉ chi tiết</option>
                        <option value="7">Tổng chi tiêu</option></option>
                    </select>
                </div>
            </div>
        </div>
...
<script>
    $(document).ready(function() {
        loadPage("#userPage")
        initTable("#user_table", "/admin/getTopUser")
    })
</script>